...
right_turn = ["0","255","255","0"]
left_turn = ["255","0","0","255"]
stop = ["0","0","0","0"]
...
while 1:
    for s in solution:
        if s == "N":
            clientConnected.send(forward.encode());
        elif s == "S":
            clientConnected.send(backward.encode());
        elif s == "E":
            clientConnected.send(right_turn.encode());
        elif s == "W":
            clientConnected.send(left_turn.encode());
        else:
            clientConnected.send(stop.encode());
